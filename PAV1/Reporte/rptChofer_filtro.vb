...
Public Class rptChofer_filtro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAV1.rptChofer_filtro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChofer_filtro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChofer_filtro = New rptChofer_filtro()
        rpt.Site = Me.Site
        Return rpt
    End Function
