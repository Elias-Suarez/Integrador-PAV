...
Public Class rptKmMensuales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAV1.rptKmMensuales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKmMensuales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKmMensuales = New rptKmMensuales()
        rpt.Site = Me.Site
        Return rpt
    End Function
